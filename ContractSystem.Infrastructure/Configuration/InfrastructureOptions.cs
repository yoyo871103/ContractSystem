namespace ContractSystem.Infrastructure.Configuration;
...
public sealed class InfrastructureOptions
{
    ...
    /// - Windows: por defecto AppData\ContractSystem
    /// - MAUI: FileSystem.AppDataDirectory (configurar explícitamente)
    /// </summary>
    public string DataDirectory { get; set; } =
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "ContractSystem");
